...
<jsp:useBean id="calcBean" class="chen.entity.CalculatorBean"/>
<%--接收用户输入的参数 --%>
...
<br/><hr> <br/>
<form action="/jsp/calculator/calculator.jsp" method="post">
    <table border="1px">
        <tr>
        ...
        <tr>
            <td colspan="10"><input type="submit" value="计算"></td>
        </tr>
    </table>
</form>
</body>
